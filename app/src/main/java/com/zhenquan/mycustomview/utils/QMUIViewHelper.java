...
public class QMUIViewHelper {
    ...
    public static
    @Nullable
    TranslateAnimation slideFadeIn(final View view, int duration, final Animation.AnimationListener listener, boolean isNeedAnimation, QMUIDirection direction) {
        if (view == null) {
            return null;
        }
        if (isNeedAnimation) {
